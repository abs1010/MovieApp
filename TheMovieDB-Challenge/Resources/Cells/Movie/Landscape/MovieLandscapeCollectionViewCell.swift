...
class MovieLandscapeCollectionViewCell: UICollectionViewCell {
    ...
    static let nibName = "MovieLandscapeCollectionViewCell"
    static var identifier = "LandscapeMovieCell"
    ...
    func setupCell(movie: Movie) {
        ...
        if let urlString = movie.posterPath {
            ...
            self.movieImageView.loadUrlImageFromSDWeb(urlString: urlString, type: .cover, done: { [weak self] isLoadFinished in
